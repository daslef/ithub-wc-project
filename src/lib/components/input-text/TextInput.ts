...
//         return ["required", "value", "disabled", "name"];
//     }

//     attributeChangedCallback(name: string, _: any, next: any) {
//         this.attr[name] = next;
...
//     set validator(validatorObject: Validator) {
